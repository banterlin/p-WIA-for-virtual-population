...
%
%%
function [Pr,A,B,Pinf,Tn,Pn,dp,nn]=kreservoir_v14(P,Tb, sampling_rate)
...
% find the minimum dp to determine Tn
    dp=fsg721(p);
    [~,nn]=min(dp); 
%     nn = round(nn + nn/3);       % Using last two thrid of diastolic 
%     nn=500;       %% potential to add a potential variable input nn, for
