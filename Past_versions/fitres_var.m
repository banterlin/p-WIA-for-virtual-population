...
%%
function  [P_av, Pr_av,Pinf_av,Pn_av,Tn_av,Sn_av,fita_av,fitb_av,rsq_av]=fitres_var(pulse,sampling_rate,n) 
%%
...
% (a) exclude diff (p)>0 in diastole
    ...
    [Pr_av,fita_av,fitb_av,Pinf_av,Tn_av,Pn_av]=kreservoir_var(P_av,T_av, sampling_rate,n);
