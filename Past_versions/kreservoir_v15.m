...
%  v14 onwards are modified by Lin
...
%  v.15 changed notch timing detection to using zero crossing on the first
...
%     nn=280;       %% potential to add a potential variable input nn, for
