...
%  v.16 using last 2/3 of the diastolic decay for expoential fitting.
%%
function [Pr,A,B,Pinf,Tn,Pn,dp,nn]=kreservoir_v16(P,Tb, sampling_rate)
...
% find the minimum dp to determine Tn
    dp=fsg721(p);
    [~,nn]=min(dp); 
    % Update new fitting time as last 1/2 of diastole
    nn = nn + round((Nb - nn)* 1/2) ;
